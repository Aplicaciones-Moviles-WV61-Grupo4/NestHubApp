                    ...
                    children: [
                      TextFormField(
                        ...
                        decoration: const InputDecoration(
                          labelText: 'Nombre que aparece en su documento de identidad',
                          labelStyle: TextStyle(fontSize: 13, fontWeight: FontWeight.w200), // Tamaño más pequeño para labelText
                          hintText: 'Nombre que aparece en su documento de identidad',
                          hintStyle: TextStyle(fontSize: 15), // Tamaño más grande para hintText
                      ...
                      TextFormField(
                        ...
                        decoration: const InputDecoration(
                          labelText: 'Apellidos que aparece en su documento de identidad',
                          labelStyle: TextStyle(fontSize: 13, fontWeight: FontWeight.w200),
                          hintText: 'Apellidos que aparece en su documento de identidad',
